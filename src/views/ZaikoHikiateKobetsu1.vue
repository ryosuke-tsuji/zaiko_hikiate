    ...
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-col class="d-flex justify-center">
          <v-btn class="mx-5 mb-3 secondary" large href="zaiko_hikiate_kobetsu2"><span>引当保留</span></v-btn>
          <v-btn class="mx-5 mb-3 secondary" large href="zaiko_hikiate_kobetsu2"><span>強制決定</span></v-btn>
          <v-btn class="mx-5 mb-3 primary" large href="zaiko_hikiate_kobetsu2"><span>決定</span></v-btn>
        </v-col>
