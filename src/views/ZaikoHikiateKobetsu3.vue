    ...
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-col class="d-flex justify-center">
          <v-btn class="mx-5 mb-3 secondary" large href="zaiko_hikiate_kobetsu4"><span>引当保留</span></v-btn>
          <v-btn class="mx-5 mb-3 secondary" large href="zaiko_hikiate_kobetsu4"><span>強制決定</span></v-btn>
          <v-btn class="mx-5 mb-3 primary" large href="zaiko_hikiate_kobetsu4"><span>決定</span></v-btn>
        </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      itemsSum: [
        { hikiateCnt: "52,500 S", kansanCnt: "52,500 S", fusokuCnt: "0 S"}
      ],
      itemsKobetsu: [
        {
          ID: 1,
